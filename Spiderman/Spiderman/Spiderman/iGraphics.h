...
int iSetTimer(int msec, void(*f)(void))
{
	...
	if (iAnimCount >= 100){ printf("Error: Maximum number of already timer used.\n"); return -1; }
...
//shaafi--new ediited iText to show text from the string variable
